...
import {
  GaxiosOptions,
  GaxiosResponse
} from "google-auth-library/build/src/auth/node_modules/gaxios";
import * as stream from "stream";
import {
  DefaultTransporter,
  Transporter
} from "google-auth-library/build/src/transporters";
import { Compute } from "google-auth-library/build/src/auth/computeclient";
import {
  CredentialBody,
  JWTInput
} from "google-auth-library/build/src/auth/credentials";
import { GCPEnv } from "google-auth-library/build/src/auth/envDetect";
import { JWT, JWTOptions } from "google-auth-library/build/src/auth/jwtclient";
import {
  Headers,
  OAuth2Client,
  OAuth2ClientOptions,
...
} from "google-auth-library/build/src/auth/refreshclient";
...
export declare const CLOUD_SDK_CLIENT_ID =
