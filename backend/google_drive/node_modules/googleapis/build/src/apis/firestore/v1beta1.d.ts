 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/firestore/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/firestore/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/firestore/node_modules/googleapis-common';
export declare namespace firestore_v1beta1 {
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1ExportDocumentsMetadata {
        /**
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1ExportDocumentsRequest {
        /**
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1ExportDocumentsResponse {
        /**
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1ImportDocumentsMetadata {
        /**
     ...
     * An index definition.
     */
    interface Schema$GoogleFirestoreAdminV1beta1Index {
        /**
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1IndexOperationMetadata {
        /**
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1ListIndexesResponse {
        /**
         * The indexes.
         */
     ...
     */
    interface Schema$GoogleFirestoreAdminV1beta1LocationMetadata {
    }
    /**
     * Measures the progress of a particular metric.
     */
    interface Schema$GoogleFirestoreAdminV1beta1Progress {
        /**
    ...
    interface Params$Resource$Projects$Databases$Indexes$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Databases$Indexes$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Databases$Indexes$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Databases$Indexes$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
