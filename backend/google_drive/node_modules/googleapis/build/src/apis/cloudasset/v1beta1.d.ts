 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/cloudasset/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/cloudasset/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/cloudasset/node_modules/googleapis-common';
export declare namespace cloudasset_v1beta1 {
    ...
    interface Params$Resource$Folders$Exportassets extends StandardParameters {
        /**
    ...
    interface Params$Resource$Folders$Operations$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
