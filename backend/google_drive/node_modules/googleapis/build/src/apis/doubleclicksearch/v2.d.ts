 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/doubleclicksearch/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/doubleclicksearch/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/doubleclicksearch/node_modules/googleapis-common';
export declare namespace doubleclicksearch_v2 {
     ...
     */
    interface Schema$ConversionList {
        /**
     ...
     */
    interface Schema$ReportApiColumnSpec {
        /**
     ...
     */
    interface Schema$SavedColumnList {
        /**
     ...
     */
    interface Schema$UpdateAvailabilityRequest {
        /**
     ...
     */
    interface Schema$UpdateAvailabilityResponse {
        /**
    ...
    interface Params$Resource$Conversion$Get extends StandardParameters {
        /**
    ...
    interface Params$Resource$Conversion$Insert extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Conversion$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Conversion$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Conversion$Updateavailability extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Reports$Getfile extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Reports$Request extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Savedcolumns$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
