 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/dlp/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/dlp/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/dlp/node_modules/googleapis-common';
export declare namespace dlp_v2 {
     ...
     */
    interface Schema$GooglePrivacyDlpV2ActivateJobTriggerRequest {
    }
    /**
     ...
     */
    interface Schema$GooglePrivacyDlpV2CryptoDeterministicConfig {
        /**
     ...
     * completion/failure.
     */
    interface Schema$GooglePrivacyDlpV2JobNotificationEmails {
    }
    /**
    ...
    interface Params$Resource$Projects$Jobtriggers$Activate extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
