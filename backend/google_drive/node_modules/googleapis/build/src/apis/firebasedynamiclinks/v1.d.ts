 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/firebasedynamiclinks/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/firebasedynamiclinks/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/firebasedynamiclinks/node_modules/googleapis-common';
export declare namespace firebasedynamiclinks_v1 {
     ...
     */
    interface Schema$GetIosReopenAttributionRequest {
        /**
         * APP bundle ID.
         */
        bundleId?: string;
     ...
     * deeplinking. This endpoint is meant for only iOS requests.
     */
    interface Schema$GetIosReopenAttributionResponse {
        /**
    ...
    interface Params$Resource$Managedshortlinks$Create extends StandardParameters {
        /**
    ...
    interface Params$Resource$Shortlinks$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$V1$Getlinkstats extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$V1$Installattribution extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$V1$Reopenattribution extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
