 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/firebaserules/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/firebaserules/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/firebaserules/node_modules/googleapis-common';
export declare namespace firebaserules_v1 {
     ...
     */
    interface Schema$GetReleaseExecutableResponse {
        /**
     ...
     */
    interface Schema$SourcePosition {
        /**
     ...
     */
    interface Schema$TestRulesetRequest {
        /**
     ...
     */
    interface Schema$TestRulesetResponse {
        /**
     ...
     */
    interface Schema$UpdateReleaseRequest {
        /**
         * `Release` to update.
         */
     ...
     */
    interface Schema$VisitedExpression {
        /**
    ...
    interface Params$Resource$Projects$Test extends StandardParameters {
        /**
    ...
    interface Params$Resource$Projects$Releases$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Releases$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Releases$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Releases$Getexecutable extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Releases$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Releases$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Rulesets$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Rulesets$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Rulesets$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Rulesets$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
