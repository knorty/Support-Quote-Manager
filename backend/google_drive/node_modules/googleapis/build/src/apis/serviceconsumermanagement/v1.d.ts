 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/serviceconsumermanagement/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/serviceconsumermanagement/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/serviceconsumermanagement/node_modules/googleapis-common';
export declare namespace serviceconsumermanagement_v1 {
     ...
     */
    interface Schema$DeleteTenantProjectRequest {
        /**
     ...
     * the tenancy unit.
     */
    interface Schema$UndeleteTenantProjectRequest {
        /**
         * Tag of the resource within the tenancy unit.
         */
        tag?: string;
    ...
    interface Params$Resource$Services$Tenancyunits$Deleteproject extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Services$Tenancyunits$Undeleteproject extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
