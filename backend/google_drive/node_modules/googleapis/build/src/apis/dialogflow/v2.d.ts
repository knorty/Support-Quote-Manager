 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/dialogflow/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/dialogflow/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/dialogflow/node_modules/googleapis-common';
export declare namespace dialogflow_v2 {
     ...
     */
    interface Schema$GoogleCloudDialogflowV2OutputAudioConfig {
        /**
     ...
     * of analysis, such as the query text.
     */
    interface Schema$GoogleCloudDialogflowV2Sentiment {
        /**
         * A non-negative number in the [0, +inf) range, which represents the
         * absolute magnitude of sentiment, regardless of score (positive or
         * negative).
     ...
     */
    interface Schema$GoogleCloudDialogflowV2SentimentAnalysisRequestConfig {
        /**
     ...
     * `sentiment_analysis_request_config`.
     */
    interface Schema$GoogleCloudDialogflowV2SentimentAnalysisResult {
        /**
         * The sentiment analysis result for `query_text`.
         */
     ...
     */
    interface Schema$GoogleCloudDialogflowV2SynthesizeSpeechConfig {
        /**
     ...
     */
    interface Schema$GoogleCloudDialogflowV2VoiceSelectionParams {
        /**
