 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/slides/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/slides/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/slides/node_modules/googleapis-common';
export declare namespace slides_v1 {
     ...
     */
    interface Schema$PageProperties {
        /**
     ...
     */
    interface Schema$ParagraphMarker {
        /**
     ...
     * drive OAuth scopes.
     */
    interface Schema$RefreshSheetsChartRequest {
        /**
     ...
     */
    interface Schema$ReplaceAllShapesWithImageRequest {
        /**
     ...
     */
    interface Schema$ReplaceAllShapesWithImageResponse {
        /**
     ...
     * drive OAuth scopes.
     */
    interface Schema$ReplaceAllShapesWithSheetsChartRequest {
        /**
         * The ID of the specific chart in the Google Sheets spreadsheet.
         */
        chartId?: number;
     ...
     */
    interface Schema$ReplaceAllShapesWithSheetsChartResponse {
        /**
     ...
     */
    interface Schema$ReplaceImageRequest {
        /**
     ...
     */
    interface Schema$RerouteLineRequest {
        /**
     ...
     */
    interface Schema$ShapeBackgroundFill {
        /**
     ...
     */
    interface Schema$ShapeProperties {
        /**
     ...
     */
    interface Schema$SheetsChartProperties {
        /**
     ...
     * SLIDE.
     */
    interface Schema$SlideProperties {
        /**
     ...
     */
    interface Schema$StretchedPictureFill {
        /**
     ...
     */
    interface Schema$TableBorderCell {
        /**
     ...
     */
    interface Schema$TableBorderFill {
        /**
         * Solid fill.
         */
        solidFill?: Schema$SolidFill;
     ...
     */
    interface Schema$TableBorderProperties {
        /**
     ...
     */
    interface Schema$TableBorderRow {
        /**
     ...
     */
    interface Schema$TableCellBackgroundFill {
        /**
     ...
     */
    interface Schema$TableCellProperties {
        /**
     ...
     */
    interface Schema$TableRowProperties {
        /**
     ...
     */
    interface Schema$ThemeColorPair {
        /**
     ...
     * Ungroups objects, such as groups.
     */
    interface Schema$UngroupObjectsRequest {
        /**
     ...
     * Unmerges cells in a Table.
     */
    interface Schema$UnmergeTableCellsRequest {
        /**
         * The object ID of the table.
         */
        objectId?: string;
     ...
     */
    interface Schema$UpdateImagePropertiesRequest {
        /**
     ...
     * Updates the category of a line.
     */
    interface Schema$UpdateLineCategoryRequest {
        /**
     ...
     * Updates the properties of a Line.
     */
    interface Schema$UpdateLinePropertiesRequest {
        /**
         * The fields that should be updated.  At least one field must be specified.
     ...
     * Updates the alt text title and/or description of a page element.
     */
    interface Schema$UpdatePageElementAltTextRequest {
        /**
     ...
     */
    interface Schema$UpdatePageElementsZOrderRequest {
        /**
     ...
     */
    interface Schema$UpdatePageElementTransformRequest {
        /**
     ...
     * Updates the properties of a Page.
     */
    interface Schema$UpdatePagePropertiesRequest {
        /**
         * The fields that should be updated.  At least one field must be specified.
     ...
     */
    interface Schema$UpdateShapePropertiesRequest {
        /**
         * The fields that should be updated.  At least one field must be specified.
     ...
     */
    interface Schema$UpdateSlidesPositionRequest {
        /**
     ...
     * Updates the properties of the table borders in a Table.
     */
    interface Schema$UpdateTableBorderPropertiesRequest {
        /**
     ...
     */
    interface Schema$UpdateTableCellPropertiesRequest {
        /**
         * The fields that should be updated.  At least one field must be specified.
     ...
     * Updates the properties of a Table row.
     */
    interface Schema$UpdateTableRowPropertiesRequest {
        /**
         * The fields that should be updated.  At least one field must be specified.
     ...
     */
    interface Schema$UpdateVideoPropertiesRequest {
        /**
         * The fields that should be updated.  At least one field must be specified.
     ...
     * The properties of the Video.
     */
    interface Schema$VideoProperties {
        /**
    ...
    interface Params$Resource$Presentations$Batchupdate extends StandardParameters {
        /**
    ...
    interface Params$Resource$Presentations$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Presentations$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Presentations$Pages$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Presentations$Pages$Getthumbnail extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
