 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/streetviewpublish/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/streetviewpublish/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/streetviewpublish/node_modules/googleapis-common';
export declare namespace streetviewpublish_v1 {
     ...
     */
    interface Schema$BatchDeletePhotosRequest {
        /**
     ...
     */
    interface Schema$BatchDeletePhotosResponse {
        /**
     ...
     */
    interface Schema$BatchGetPhotosResponse {
        /**
     ...
     * not supported.
     */
    interface Schema$BatchUpdatePhotosRequest {
        /**
     ...
     */
    interface Schema$BatchUpdatePhotosResponse {
        /**
     ...
     */
    interface Schema$ListPhotosResponse {
        /**
     ...
     */
    interface Schema$PhotoResponse {
        /**
     ...
     * is not supported.
     */
    interface Schema$UpdatePhotoRequest {
        /**
    ...
    interface Params$Resource$Photo$Create extends StandardParameters {
        /**
    ...
    interface Params$Resource$Photo$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photo$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photo$Startupload extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photo$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photos$Batchdelete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photos$Batchget extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photos$Batchupdate extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Photos$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
