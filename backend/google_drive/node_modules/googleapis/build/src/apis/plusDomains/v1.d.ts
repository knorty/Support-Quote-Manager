 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/plusDomains/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/plusDomains/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/plusDomains/node_modules/googleapis-common';
export declare namespace plusDomains_v1 {
    ...
    interface Schema$AudiencesFeed {
        /**
         * ETag of this response for caching purposes.
         */
        etag?: string;
    ...
    interface Schema$PlusDomainsAclentryResource {
        /**
    ...
    interface Params$Resource$Activities$Get extends StandardParameters {
        /**
    ...
    interface Params$Resource$Audiences$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Circles$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Media$Insert extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$People {
         ...
         * @return {object} Request object
         */
        listByCircle(params?: Params$Resource$People$Listbycircle, options?: MethodOptions): GaxiosPromise<Schema$PeopleFeed>;
        listByCircle(params: Params$Resource$People$Listbycircle, options: MethodOptions | BodyResponseCallback<Schema$PeopleFeed>, callback: BodyResponseCallback<Schema$PeopleFeed>): void;
        listByCircle(params: Params$Resource$People$Listbycircle, callback: BodyResponseCallback<Schema$PeopleFeed>): void;
    ...
    interface Params$Resource$People$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$People$Listbyactivity extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$People$Listbycircle extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
