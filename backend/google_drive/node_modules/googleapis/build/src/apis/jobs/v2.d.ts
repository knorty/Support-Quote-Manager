 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/jobs/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/jobs/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/jobs/node_modules/googleapis-common';
export declare namespace jobs_v2 {
     ...
     */
    interface Schema$CommutePreference {
        /**
     ...
     */
    interface Schema$CompanyInfoSource {
        /**
     ...
     */
    interface Schema$CustomFieldFilter {
        /**
     ...
     */
    interface Schema$DeleteJobsByFilterRequest {
        /**
     ...
     */
    interface Schema$ExtendedCompensationFilter {
        /**
         * Optional.  Compensation range.
         */
     ...
     */
    interface Schema$ExtendedCompensationInfo {
        /**
     ...
     */
    interface Schema$ExtendedCompensationInfoCompensationEntry {
        /**
     ...
     */
    interface Schema$ExtendedCompensationInfoCompensationRange {
        /**
     ...
     */
    interface Schema$ExtendedCompensationInfoDecimal {
        /**
     ...
     * `GetHistogram` method.
     */
    interface Schema$GetHistogramRequest {
        /**
     ...
     * GetHistogram method.
     */
    interface Schema$GetHistogramResponse {
        /**
         * Additional information for the API invocation, such as the request
         * tracking id.
         */
     ...
     */
    interface Schema$JobProcessingOptions {
        /**
     ...
     * response object.
     */
    interface Schema$ListCompanyJobsResponse {
        /**
    ...
    interface Params$Resource$Companies$Create extends StandardParameters {
        /**
    ...
    interface Params$Resource$Companies$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Companies$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Companies$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Companies$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Companies$Jobs$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Batchdelete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Deletebyfilter extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Histogram extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Search extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Searchforalert extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$V2$Complete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
