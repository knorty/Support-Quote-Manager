 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/poly/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/poly/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/poly/node_modules/googleapis-common';
export declare namespace poly_v1 {
     ...
     */
    interface Schema$AssetImportMessage {
        /**
     ...
     * A response message from a request to list.
     */
    interface Schema$ListLikedAssetsResponse {
        /**
         * A list of assets that match the criteria specified in the request.
         */
        assets?: Schema$Asset[];
     ...
     */
    interface Schema$ObjParseError {
        /**
     ...
     * asset was uploaded.
     */
    interface Schema$PresentationParams {
        /**
     ...
     */
    interface Schema$StartAssetImportResponse {
        /**
    ...
    interface Params$Resource$Assets$Get extends StandardParameters {
        /**
    ...
    interface Params$Resource$Assets$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Users$Assets$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Users$Likedassets$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
