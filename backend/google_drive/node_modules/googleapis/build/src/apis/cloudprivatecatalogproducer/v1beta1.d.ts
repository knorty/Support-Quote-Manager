 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/cloudprivatecatalogproducer/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/cloudprivatecatalogproducer/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/cloudprivatecatalogproducer/node_modules/googleapis-common';
export declare namespace cloudprivatecatalogproducer_v1beta1 {
     ...
     */
    class Cloudprivatecatalogproducer {
     ...
     */
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1Association {
        /**
    ...
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1CopyProductRequest {
        /**
         * The resource name of the destination product that is copied to.
         */
        destinationProductName?: string;
    }
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1CreateAssociationRequest {
        /**
    ...
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse {
        /**
    ...
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1ListCatalogsResponse {
        /**
    ...
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1ListProductsResponse {
        /**
    ...
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1ListVersionsResponse {
        /**
         * A pagination token returned from a previous call to ListProducts that
         * indicates where the listing should continue from. This field is optional.
         */
     ...
     */
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1Product {
        /**
    ...
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1UndeleteCatalogRequest {
    }
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1UploadIconRequest {
        /**
     ...
     */
    interface Schema$GoogleCloudPrivatecatalogproducerV1beta1Version {
        /**
     ...
     */
    interface Schema$GoogleIamV1AuditConfig {
        /**
     ...
     */
    interface Schema$GoogleIamV1AuditLogConfig {
        /**
     ...
     */
    interface Schema$GoogleIamV1Binding {
        /**
     ...
     */
    interface Schema$GoogleIamV1Policy {
        /**
     ...
     */
    interface Schema$GoogleIamV1SetIamPolicyRequest {
        /**
     ...
     */
    interface Schema$GoogleIamV1TestIamPermissionsRequest {
        /**
     ...
     */
    interface Schema$GoogleIamV1TestIamPermissionsResponse {
        /**
     ...
     */
    interface Schema$GoogleTypeExpr {
        /**
    ...
    interface Params$Resource$Catalogs$Create extends StandardParameters {
        /**
    ...
    interface Params$Resource$Catalogs$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Getiampolicy extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Setiampolicy extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Testiampermissions extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Undelete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Catalogs$Associations {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
    ...
    interface Params$Resource$Catalogs$Associations$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Associations$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Associations$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Associations$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Catalogs$Products {
        context: APIRequestContext;
    ...
    interface Params$Resource$Catalogs$Products$Copy extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Catalogs$Products$Icons {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
    ...
    interface Params$Resource$Catalogs$Products$Icons$Upload extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Catalogs$Products$Versions {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
    ...
    interface Params$Resource$Catalogs$Products$Versions$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Versions$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Versions$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Versions$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Catalogs$Products$Versions$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
