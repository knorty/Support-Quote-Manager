 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/webmasters/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/webmasters/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/webmasters/node_modules/googleapis-common';
export declare namespace webmasters_v3 {
    ...
    interface Schema$ApiDimensionFilter {
        dimension?: string;
        expression?: string;
        operator?: string;
    }
    interface Schema$ApiDimensionFilterGroup {
        filters?: Schema$ApiDimensionFilter[];
        groupType?: string;
    }
    interface Schema$SearchAnalyticsQueryRequest {
        /**
     ...
     */
    interface Schema$SearchAnalyticsQueryResponse {
        /**
     ...
     * List of sitemaps.
     */
    interface Schema$SitemapsListResponse {
        /**
     ...
     * category).
     */
    interface Schema$UrlCrawlErrorCountsPerType {
        /**
     ...
     * platform.
     */
    interface Schema$UrlCrawlErrorsCountsQueryResponse {
        /**
     ...
     */
    interface Schema$UrlCrawlErrorsSample {
        /**
     ...
     */
    interface Schema$UrlCrawlErrorsSamplesListResponse {
        /**
     ...
     * Additional details about the URL, set only when calling get().
     */
    interface Schema$UrlSampleDetails {
        /**
     ...
     */
    interface Schema$WmxSitemapContent {
        /**
    ...
    interface Params$Resource$Searchanalytics$Query extends StandardParameters {
        /**
    ...
    interface Params$Resource$Sitemaps$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sitemaps$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sitemaps$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sitemaps$Submit extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sites$Add extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Sites$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Urlcrawlerrorscounts {
         ...
         * @return {object} Request object
         */
        query(params?: Params$Resource$Urlcrawlerrorscounts$Query, options?: MethodOptions): GaxiosPromise<Schema$UrlCrawlErrorsCountsQueryResponse>;
        query(params: Params$Resource$Urlcrawlerrorscounts$Query, options: MethodOptions | BodyResponseCallback<Schema$UrlCrawlErrorsCountsQueryResponse>, callback: BodyResponseCallback<Schema$UrlCrawlErrorsCountsQueryResponse>): void;
        query(params: Params$Resource$Urlcrawlerrorscounts$Query, callback: BodyResponseCallback<Schema$UrlCrawlErrorsCountsQueryResponse>): void;
        query(callback: BodyResponseCallback<Schema$UrlCrawlErrorsCountsQueryResponse>): void;
    }
    interface Params$Resource$Urlcrawlerrorscounts$Query extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Urlcrawlerrorssamples {
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Urlcrawlerrorssamples$Get, options?: MethodOptions): GaxiosPromise<Schema$UrlCrawlErrorsSample>;
        get(params: Params$Resource$Urlcrawlerrorssamples$Get, options: MethodOptions | BodyResponseCallback<Schema$UrlCrawlErrorsSample>, callback: BodyResponseCallback<Schema$UrlCrawlErrorsSample>): void;
        get(params: Params$Resource$Urlcrawlerrorssamples$Get, callback: BodyResponseCallback<Schema$UrlCrawlErrorsSample>): void;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Urlcrawlerrorssamples$List, options?: MethodOptions): GaxiosPromise<Schema$UrlCrawlErrorsSamplesListResponse>;
        list(params: Params$Resource$Urlcrawlerrorssamples$List, options: MethodOptions | BodyResponseCallback<Schema$UrlCrawlErrorsSamplesListResponse>, callback: BodyResponseCallback<Schema$UrlCrawlErrorsSamplesListResponse>): void;
        list(params: Params$Resource$Urlcrawlerrorssamples$List, callback: BodyResponseCallback<Schema$UrlCrawlErrorsSamplesListResponse>): void;
        list(callback: BodyResponseCallback<Schema$UrlCrawlErrorsSamplesListResponse>): void;
        /**
         ...
         * @return {object} Request object
         */
        markAsFixed(params?: Params$Resource$Urlcrawlerrorssamples$Markasfixed, options?: MethodOptions): GaxiosPromise<void>;
        markAsFixed(params: Params$Resource$Urlcrawlerrorssamples$Markasfixed, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        markAsFixed(params: Params$Resource$Urlcrawlerrorssamples$Markasfixed, callback: BodyResponseCallback<void>): void;
        markAsFixed(callback: BodyResponseCallback<void>): void;
    }
    interface Params$Resource$Urlcrawlerrorssamples$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Urlcrawlerrorssamples$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Urlcrawlerrorssamples$Markasfixed extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
