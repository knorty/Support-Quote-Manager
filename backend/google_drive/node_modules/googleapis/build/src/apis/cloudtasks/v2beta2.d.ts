 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/cloudtasks/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/cloudtasks/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/cloudtasks/node_modules/googleapis-common';
export declare namespace cloudtasks_v2beta2 {
     ...
     */
    interface Schema$AcknowledgeTaskRequest {
        /**
     ...
     */
    interface Schema$AppEngineHttpTarget {
        /**
     ...
     */
    interface Schema$AttemptStatus {
        /**
     ...
     */
    interface Schema$CancelLeaseRequest {
        /**
     ...
     */
    interface Schema$LeaseTasksRequest {
        /**
     ...
     */
    interface Schema$LeaseTasksResponse {
        /**
         * The leased tasks.
         */
        tasks?: Schema$Task[];
     ...
     */
    interface Schema$RenewLeaseRequest {
        /**
    ...
    interface Params$Resource$Projects$Locations$Queues$Tasks$Acknowledge extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Locations$Queues$Tasks$Cancellease extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Locations$Queues$Tasks$Lease extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Locations$Queues$Tasks$Renewlease extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
