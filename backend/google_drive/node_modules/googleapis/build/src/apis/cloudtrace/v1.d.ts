 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/cloudtrace/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/cloudtrace/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/cloudtrace/node_modules/googleapis-common';
export declare namespace cloudtrace_v1 {
     ...
     */
    interface Schema$ListTracesResponse {
        /**
    ...
    interface Params$Resource$Projects$Patchtraces extends StandardParameters {
        /**
    ...
    interface Params$Resource$Projects$Traces$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Traces$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
