 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/manufacturers/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/manufacturers/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/manufacturers/node_modules/googleapis-common';
export declare namespace manufacturers_v1 {
     ...
     */
    interface Schema$DestinationStatus {
        /**
     ...
     * https://support.google.com/manufacturers/answer/6124116#featuredesc.
     */
    interface Schema$FeatureDescription {
        /**
     ...
     * https://support.google.com/manufacturers/answer/6124116#productdetail.
     */
    interface Schema$ProductDetail {
        /**
    ...
    interface Params$Resource$Accounts$Products$Delete extends StandardParameters {
        /**
    ...
    interface Params$Resource$Accounts$Products$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
