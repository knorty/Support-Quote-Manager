 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/youtube/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/youtube/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/youtube/node_modules/googleapis-common';
export declare namespace youtube_v3 {
    ...
    interface Schema$LiveChatSuperStickerDetails {
        /**
         * A rendered string that displays the fund amount and currency to the user.
         */
        amountDisplayString?: string;
    ...
    interface Schema$SuperStickerMetadata {
        /**
