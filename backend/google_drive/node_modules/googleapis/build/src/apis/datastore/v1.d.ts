 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/datastore/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/datastore/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/datastore/node_modules/googleapis-common';
export declare namespace datastore_v1 {
     ...
     */
    interface Schema$AllocateIdsRequest {
        /**
     ...
     */
    interface Schema$AllocateIdsResponse {
        /**
     ...
     */
    interface Schema$GoogleDatastoreAdminV1ExportEntitiesRequest {
        /**
     ...
     */
    interface Schema$GoogleDatastoreAdminV1ImportEntitiesRequest {
        /**
     ...
     */
    interface Schema$GoogleDatastoreAdminV1Index {
        /**
     ...
     */
    interface Schema$GoogleDatastoreAdminV1IndexedProperty {
        /**
     ...
     */
    interface Schema$GoogleDatastoreAdminV1ListIndexesResponse {
        /**
         * The indexes.
         */
     ...
     */
    interface Schema$GqlQueryParameter {
        /**
     ...
     */
    interface Schema$KindExpression {
        /**
     ...
     */
    interface Schema$LookupRequest {
        /**
     ...
     */
    interface Schema$LookupResponse {
        /**
     ...
     */
    interface Schema$MutationResult {
        /**
     ...
     */
    interface Schema$PropertyFilter {
        /**
     ...
     */
    interface Schema$PropertyOrder {
        /**
     ...
     */
    interface Schema$PropertyReference {
        /**
     ...
     */
    interface Schema$QueryResultBatch {
        /**
     ...
     */
    interface Schema$ReserveIdsRequest {
        /**
     ...
     */
    interface Schema$ReserveIdsResponse {
    }
    /**
     ...
     */
    interface Schema$RollbackResponse {
    }
    /**
    ...
    interface Params$Resource$Projects$Allocateids extends StandardParameters {
        /**
    ...
    interface Params$Resource$Projects$Begintransaction extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Commit extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Lookup extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Reserveids extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Rollback extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Runquery extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Indexes$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Indexes$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Projects$Operations$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
