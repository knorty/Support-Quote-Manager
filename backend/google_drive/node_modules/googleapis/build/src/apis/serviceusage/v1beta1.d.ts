 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/serviceusage/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/serviceusage/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/serviceusage/node_modules/googleapis-common';
export declare namespace serviceusage_v1beta1 {
     ...
     */
    interface Schema$BatchEnableServicesRequest {
        /**
     ...
     */
    interface Schema$BatchEnableServicesResponse {
        /**
     ...
     * operation is done.
     */
    interface Schema$DisableServiceResponse {
        /**
     ...
     */
    interface Schema$EnableFailure {
        /**
     ...
     * operation is done.
     */
    interface Schema$EnableServiceResponse {
        /**
     ...
     * requirements:           provider_id: google_calendar_auth
     */
    interface Schema$GoogleApiService {
        /**
     ...
     */
    interface Schema$GoogleApiServiceusageV1OperationMetadata {
        /**
     ...
     */
    interface Schema$GoogleApiServiceusageV1Service {
        /**
     ...
     */
    interface Schema$GoogleApiServiceusageV1ServiceConfig {
        /**
     ...
     * The configuration of the service.
     */
    interface Schema$ServiceConfig {
        /**
         * A list of API interfaces exported by this service. Contains only the
         * names, versions, and method names of the interfaces.
         */
    ...
    interface Params$Resource$Services$Batchenable extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
