 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/clouddebugger/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/clouddebugger/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/clouddebugger/node_modules/googleapis-common';
export declare namespace clouddebugger_v2 {
     ...
     */
    interface Schema$CloudWorkspaceId {
        /**
     ...
     */
    interface Schema$CloudWorkspaceSourceContext {
        /**
     ...
     */
    interface Schema$ExtendedSourceContext {
        /**
         * Any source context.
         */
     ...
     */
    interface Schema$FormatMessage {
        /**
     ...
     */
    interface Schema$GetBreakpointResponse {
        /**
     ...
     */
    interface Schema$ListActiveBreakpointsResponse {
        /**
     ...
     */
    interface Schema$ListBreakpointsResponse {
        /**
     ...
     */
    interface Schema$ListDebuggeesResponse {
        /**
     ...
     */
    interface Schema$RegisterDebuggeeRequest {
        /**
     ...
     */
    interface Schema$RegisterDebuggeeResponse {
        /**
     ...
     */
    interface Schema$SetBreakpointResponse {
        /**
     ...
     * not found`.
     */
    interface Schema$StatusMessage {
        /**
         * Status message text.
         */
     ...
     */
    interface Schema$UpdateActiveBreakpointRequest {
        /**
     ...
     * future extensions.
     */
    interface Schema$UpdateActiveBreakpointResponse {
    }
    /**
    ...
    interface Params$Resource$Controller$Debuggees$Register extends StandardParameters {
        /**
    ...
    interface Params$Resource$Controller$Debuggees$Breakpoints$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Controller$Debuggees$Breakpoints$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Debugger$Debuggees$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Debugger$Debuggees$Breakpoints$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Debugger$Debuggees$Breakpoints$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Debugger$Debuggees$Breakpoints$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Debugger$Debuggees$Breakpoints$Set extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
