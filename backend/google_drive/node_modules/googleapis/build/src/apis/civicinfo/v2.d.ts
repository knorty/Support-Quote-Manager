 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/civicinfo/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/civicinfo/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/civicinfo/node_modules/googleapis-common';
export declare namespace civicinfo_v2 {
     ...
     */
    interface Schema$AdministrationRegion {
        /**
     ...
     * Elections).
     */
    interface Schema$AdministrativeBody {
        /**
    ...
    interface Schema$ContextParams {
        clientProfile?: string;
    }
    /**
     * A request to look up representative information for a single division.
     */
    interface Schema$DivisionRepresentativeInfoRequest {
        contextParams?: Schema$ContextParams;
    }
    /**
     * A search request for political geographies.
     */
    interface Schema$DivisionSearchRequest {
        contextParams?: Schema$ContextParams;
    }
    /**
     * The result of a division search query.
     */
    interface Schema$DivisionSearchResponse {
        /**
     ...
     * query.
     */
    interface Schema$DivisionSearchResult {
        /**
     ...
     */
    interface Schema$ElectionOfficial {
        /**
    ...
    interface Schema$ElectionsQueryRequest {
        contextParams?: Schema$ContextParams;
    }
    /**
     * The list of elections available for this version of the API.
     */
    interface Schema$ElectionsQueryResponse {
        /**
     ...
     */
    interface Schema$ElectoralDistrict {
        /**
    ...
    interface Schema$FieldMetadataProto {
        internal?: Schema$InternalFieldMetadataProto;
    }
    /**
     * Describes a political geography.
     */
    interface Schema$GeographicDivision {
        /**
    ...
    interface Schema$InternalFieldMetadataProto {
        isAuto?: boolean;
    ...
    interface Schema$LivegraphBacktraceRecordInfo {
    ...
    interface Schema$LivegraphBacktraceRecordInfoExpInfo {
        deletedIns?: string[];
    }
    interface Schema$MessageSet {
        recordMessageSetExt?: Schema$LivegraphBacktraceRecordInfo;
    }
    /**
     * Information about an Office held by one or more Officials.
     */
    interface Schema$Office {
        /**
     ...
     * ballot.
     */
    interface Schema$PollingLocation {
        /**
    ...
    interface Schema$RepresentativeInfoData {
        /**
     ...
     * address.
     */
    interface Schema$RepresentativeInfoRequest {
        contextParams?: Schema$ContextParams;
    }
    /**
     * The result of a representative info lookup query.
     */
    interface Schema$RepresentativeInfoResponse {
        /**
         * Political geographic divisions that contain the requested address.
         */
        divisions?: {
     ...
     */
    interface Schema$SimpleAddressType {
        /**
    ...
    interface Schema$StreetSegment {
    ...
    interface Schema$StreetSegmentList {
        segments?: Schema$StreetSegment[];
    }
    /**
     * A request for information about a voter.
     */
    interface Schema$VoterInfoRequest {
        contextParams?: Schema$ContextParams;
     ...
     */
    interface Schema$VoterInfoResponse {
        /**
    ...
    interface Schema$VoterInfoSegmentResult {
    ...
    interface Params$Resource$Divisions$Search extends StandardParameters {
        /**
    ...
    interface Params$Resource$Elections$Electionquery extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Elections$Voterinfoquery extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Representatives$Representativeinfobyaddress extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Representatives$Representativeinfobydivision extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
