 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/cloudfunctions/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/cloudfunctions/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/cloudfunctions/node_modules/googleapis-common';
export declare namespace cloudfunctions_v1beta2 {
    ...
    interface Params$Resource$Projects$Locations$Functions$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
