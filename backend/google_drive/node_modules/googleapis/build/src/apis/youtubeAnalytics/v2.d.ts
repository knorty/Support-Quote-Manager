 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/youtubeAnalytics/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/youtubeAnalytics/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/youtubeAnalytics/node_modules/googleapis-common';
export declare namespace youtubeAnalytics_v2 {
     ...
     * Empty response.
     */
    interface Schema$EmptyResponse {
        /**
     ...
     */
    interface Schema$GroupContentDetails {
        /**
    ...
    interface Schema$GroupItemResource {
        /**
     ...
     */
    interface Schema$ListGroupItemsResponse {
        /**
         * Apiary error details
         */
        errors?: Schema$Errors;
     ...
     */
    interface Schema$ResultTableColumnHeader {
        /**
