 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/videointelligence/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/videointelligence/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/videointelligence/node_modules/googleapis-common';
export declare namespace videointelligence_v1 {
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_AnnotateVideoProgress {
        /**
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_AnnotateVideoResponse {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_Entity {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_ExplicitContentFrame {
        /**
     ...
     * Label annotation.
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_LabelAnnotation {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_LabelFrame {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_LabelSegment {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_NormalizedBoundingBox {
        /**
         * Bottom Y coordinate.
         */
        bottom?: number;
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_NormalizedBoundingPoly {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_NormalizedVertex {
        /**
         * X coordinate.
         */
        x?: number;
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_ObjectTrackingAnnotation {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_ObjectTrackingFrame {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_SpeechRecognitionAlternative {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_SpeechTranscription {
        /**
     ...
     * detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_TextAnnotation {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_TextFrame {
        /**
     ...
     * Video segment.
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_VideoSegment {
        /**
         * Time-offset, relative to the beginning of the video, corresponding to the
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1beta2_WordInfo {
        /**
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_AnnotateVideoProgress {
        /**
         * Progress metadata for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_AnnotateVideoResponse {
        /**
         * Annotation results for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * Detected entity from video analysis.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_Entity {
        /**
         * Textual description, e.g. `Fixed-gear bicycle`.
         */
        description?: string;
     ...
     * for that frame.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_ExplicitContentAnnotation {
        /**
         * All video frames where explicit content was detected.
         */
     ...
     * Label annotation.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_LabelAnnotation {
        /**
         * Common categories for the detected entity. E.g. when the label is
         * `Terrier` the category is likely `dog`. And in some cases there might be
         * more than one categories e.g. `Terrier` could also be a `pet`.
     ...
     * Video frame level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_LabelFrame {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * Video segment level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_LabelSegment {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * the original image. Range: [0, 1].
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_NormalizedBoundingBox {
        /**
         * Bottom Y coordinate.
         */
        bottom?: number;
     ...
     * than 1 due to trignometric calculations for location of the box.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_NormalizedBoundingPoly {
        /**
         * Normalized vertices of the bounding polygon.
         */
     ...
     * coordinates are relative to the original image and range from 0 to 1.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_NormalizedVertex {
        /**
         * X coordinate.
         */
        x?: number;
     ...
     * Annotations corresponding to one tracked object.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_ObjectTrackingAnnotation {
        /**
         * Object category&#39;s labeling confidence of this track.
         */
        confidence?: number;
     ...
     * stores per frame location, time offset, and confidence.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_ObjectTrackingFrame {
        /**
         * The normalized bounding box location of this object track for the frame.
         */
     ...
     * detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_TextAnnotation {
        /**
         * All video segments where OCR detected text appears.
         */
     ...
     * containing detected OCR text snippets.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_TextFrame {
        /**
         * Bounding polygon of the detected text for this frame.
         */
     ...
     * Video segment level annotation results for text detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_TextSegment {
        /**
         * Confidence for the track of detected text. It is calculated as the
         * highest over all frames where OCR detected text appears.
         */
     ...
     * Annotation progress for a single video.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_VideoAnnotationProgress {
        /**
         * Video file location in [Google Cloud
         * Storage](https://cloud.google.com/storage/).
         */
     ...
     * Annotation results for a single video.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_VideoAnnotationResults {
        /**
         * If set, indicates an error. Note that for a single `AnnotateVideoRequest`
         * some videos may succeed and some may fail.
         */
     ...
     * Video segment.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_VideoSegment {
        /**
         * Time-offset, relative to the beginning of the video, corresponding to the
         * end of the segment (inclusive).
         */
     ...
     * `enable_word_time_offsets`.
     */
    interface Schema$GoogleCloudVideointelligenceV1p1beta1_WordInfo {
        /**
         * Output only. The confidence estimate between 0.0 and 1.0. A higher number
         * indicates an estimated greater likelihood that the recognized words are
         * correct. This field is set only for the top alternative. This field is
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_AnnotateVideoProgress {
        /**
         * Progress metadata for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_AnnotateVideoResponse {
        /**
         * Annotation results for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * Detected entity from video analysis.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_Entity {
        /**
         * Textual description, e.g. `Fixed-gear bicycle`.
         */
        description?: string;
     ...
     * for that frame.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_ExplicitContentAnnotation {
        /**
         * All video frames where explicit content was detected.
         */
     ...
     * Label annotation.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_LabelAnnotation {
        /**
         * Common categories for the detected entity. E.g. when the label is
         * `Terrier` the category is likely `dog`. And in some cases there might be
         * more than one categories e.g. `Terrier` could also be a `pet`.
     ...
     * Video frame level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_LabelFrame {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * Video segment level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_LabelSegment {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * the original image. Range: [0, 1].
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedBoundingBox {
        /**
         * Bottom Y coordinate.
         */
        bottom?: number;
     ...
     * than 1 due to trignometric calculations for location of the box.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedBoundingPoly {
        /**
         * Normalized vertices of the bounding polygon.
         */
     ...
     * coordinates are relative to the original image and range from 0 to 1.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_NormalizedVertex {
        /**
         * X coordinate.
         */
        x?: number;
     ...
     * Annotations corresponding to one tracked object.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_ObjectTrackingAnnotation {
        /**
         * Object category&#39;s labeling confidence of this track.
         */
        confidence?: number;
     ...
     * stores per frame location, time offset, and confidence.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_ObjectTrackingFrame {
        /**
         * The normalized bounding box location of this object track for the frame.
         */
     ...
     * A speech recognition result corresponding to a portion of the audio.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechTranscription {
        /**
         * May contain one or more recognition hypotheses (up to the maximum
         * specified in `max_alternatives`).  These alternatives are ordered in
         * terms of accuracy, with the top (first) alternative being the most
     ...
     * detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_TextAnnotation {
        /**
         * All video segments where OCR detected text appears.
         */
     ...
     * containing detected OCR text snippets.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_TextFrame {
        /**
         * Bounding polygon of the detected text for this frame.
         */
     ...
     * Video segment level annotation results for text detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_TextSegment {
        /**
         * Confidence for the track of detected text. It is calculated as the
         * highest over all frames where OCR detected text appears.
         */
     ...
     * Video segment.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_VideoSegment {
        /**
         * Time-offset, relative to the beginning of the video, corresponding to the
         * end of the segment (inclusive).
         */
     ...
     * `enable_word_time_offsets`.
     */
    interface Schema$GoogleCloudVideointelligenceV1p2beta1_WordInfo {
        /**
         * Output only. The confidence estimate between 0.0 and 1.0. A higher number
         * indicates an estimated greater likelihood that the recognized words are
         * correct. This field is set only for the top alternative. This field is
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoProgress {
        /**
         * Progress metadata for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoResponse {
        /**
         * Annotation results for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * Detected entity from video analysis.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_Entity {
        /**
         * Textual description, e.g. `Fixed-gear bicycle`.
         */
        description?: string;
     ...
     * for that frame.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_ExplicitContentAnnotation {
        /**
         * All video frames where explicit content was detected.
         */
     ...
     * Video frame level annotation results for explicit content.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_ExplicitContentFrame {
        /**
         * Likelihood of the pornography content..
         */
        pornographyLikelihood?: string;
     ...
     * Video frame level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_LabelFrame {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * Video segment level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_LabelSegment {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * the original image. Range: [0, 1].
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_NormalizedBoundingBox {
        /**
         * Bottom Y coordinate.
         */
        bottom?: number;
     ...
     * than 1 due to trignometric calculations for location of the box.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_NormalizedBoundingPoly {
        /**
         * Normalized vertices of the bounding polygon.
         */
     ...
     * coordinates are relative to the original image and range from 0 to 1.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_NormalizedVertex {
        /**
         * X coordinate.
         */
        x?: number;
     ...
     * Annotations corresponding to one tracked object.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingAnnotation {
        /**
         * Object category&#39;s labeling confidence of this track.
         */
        confidence?: number;
     ...
     * stores per frame location, time offset, and confidence.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingFrame {
        /**
         * The normalized bounding box location of this object track for the frame.
         */
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_StreamingAnnotateVideoResponse {
        /**
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_StreamingVideoAnnotationResults {
        /**
     ...
     * detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_TextAnnotation {
        /**
         * All video segments where OCR detected text appears.
         */
     ...
     * containing detected OCR text snippets.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_TextFrame {
        /**
         * Bounding polygon of the detected text for this frame.
         */
     ...
     * Video segment level annotation results for text detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_TextSegment {
        /**
         * Confidence for the track of detected text. It is calculated as the
         * highest over all frames where OCR detected text appears.
         */
     ...
     * Annotation progress for a single video.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgress {
        /**
         * Video file location in [Google Cloud
         * Storage](https://cloud.google.com/storage/).
         */
     ...
     * `enable_word_time_offsets`.
     */
    interface Schema$GoogleCloudVideointelligenceV1p3beta1_WordInfo {
        /**
         * Output only. The confidence estimate between 0.0 and 1.0. A higher number
         * indicates an estimated greater likelihood that the recognized words are
         * correct. This field is set only for the top alternative. This field is
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1_AnnotateVideoProgress {
        /**
         * Progress metadata for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_AnnotateVideoRequest {
        /**
     ...
     * `google::longrunning::Operations` service.
     */
    interface Schema$GoogleCloudVideointelligenceV1_AnnotateVideoResponse {
        /**
         * Annotation results for all videos specified in `AnnotateVideoRequest`.
         */
     ...
     * Detected entity from video analysis.
     */
    interface Schema$GoogleCloudVideointelligenceV1_Entity {
        /**
         * Textual description, e.g. `Fixed-gear bicycle`.
         */
        description?: string;
     ...
     * for that frame.
     */
    interface Schema$GoogleCloudVideointelligenceV1_ExplicitContentAnnotation {
        /**
         * All video frames where explicit content was detected.
         */
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_ExplicitContentDetectionConfig {
        /**
     ...
     * Video frame level annotation results for explicit content.
     */
    interface Schema$GoogleCloudVideointelligenceV1_ExplicitContentFrame {
        /**
         * Likelihood of the pornography content..
         */
        pornographyLikelihood?: string;
     ...
     * Label annotation.
     */
    interface Schema$GoogleCloudVideointelligenceV1_LabelAnnotation {
        /**
         * Common categories for the detected entity. E.g. when the label is
         * `Terrier` the category is likely `dog`. And in some cases there might be
         * more than one categories e.g. `Terrier` could also be a `pet`.
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_LabelDetectionConfig {
        /**
     ...
     * Video frame level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1_LabelFrame {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * Video segment level annotation results for label detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1_LabelSegment {
        /**
         * Confidence that the label is accurate. Range: [0, 1].
         */
        confidence?: number;
     ...
     * the original image. Range: [0, 1].
     */
    interface Schema$GoogleCloudVideointelligenceV1_NormalizedBoundingBox {
        /**
         * Bottom Y coordinate.
         */
        bottom?: number;
     ...
     * than 1 due to trignometric calculations for location of the box.
     */
    interface Schema$GoogleCloudVideointelligenceV1_NormalizedBoundingPoly {
        /**
         * Normalized vertices of the bounding polygon.
         */
     ...
     * coordinates are relative to the original image and range from 0 to 1.
     */
    interface Schema$GoogleCloudVideointelligenceV1_NormalizedVertex {
        /**
         * X coordinate.
         */
        x?: number;
     ...
     * Annotations corresponding to one tracked object.
     */
    interface Schema$GoogleCloudVideointelligenceV1_ObjectTrackingAnnotation {
        /**
         * Object category&#39;s labeling confidence of this track.
         */
        confidence?: number;
     ...
     * stores per frame location, time offset, and confidence.
     */
    interface Schema$GoogleCloudVideointelligenceV1_ObjectTrackingFrame {
        /**
         * The normalized bounding box location of this object track for the frame.
         */
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_SpeechContext {
        /**
     ...
     * Alternative hypotheses (a.k.a. n-best list).
     */
    interface Schema$GoogleCloudVideointelligenceV1_SpeechRecognitionAlternative {
        /**
         * The confidence estimate between 0.0 and 1.0. A higher number indicates an
         * estimated greater likelihood that the recognized words are correct. This
         * field is typically provided only for the top hypothesis, and only for
     ...
     * A speech recognition result corresponding to a portion of the audio.
     */
    interface Schema$GoogleCloudVideointelligenceV1_SpeechTranscription {
        /**
         * May contain one or more recognition hypotheses (up to the maximum
         * specified in `max_alternatives`).  These alternatives are ordered in
         * terms of accuracy, with the top (first) alternative being the most
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig {
        /**
     ...
     * detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1_TextAnnotation {
        /**
         * All video segments where OCR detected text appears.
         */
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_TextDetectionConfig {
        /**
     ...
     * containing detected OCR text snippets.
     */
    interface Schema$GoogleCloudVideointelligenceV1_TextFrame {
        /**
         * Bounding polygon of the detected text for this frame.
         */
     ...
     * Video segment level annotation results for text detection.
     */
    interface Schema$GoogleCloudVideointelligenceV1_TextSegment {
        /**
         * Confidence for the track of detected text. It is calculated as the
         * highest over all frames where OCR detected text appears.
         */
     ...
     * Annotation results for a single video.
     */
    interface Schema$GoogleCloudVideointelligenceV1_VideoAnnotationResults {
        /**
         * If set, indicates an error. Note that for a single `AnnotateVideoRequest`
         * some videos may succeed and some may fail.
         */
     ...
     */
    interface Schema$GoogleCloudVideointelligenceV1_VideoContext {
        /**
         * Config for EXPLICIT_CONTENT_DETECTION.
         */
     ...
     * `enable_word_time_offsets`.
     */
    interface Schema$GoogleCloudVideointelligenceV1_WordInfo {
        /**
         * Output only. The confidence estimate between 0.0 and 1.0. A higher number
         * indicates an estimated greater likelihood that the recognized words are
         * correct. This field is set only for the top alternative. This field is
     ...
     */
    interface Schema$GoogleLongrunning_CancelOperationRequest {
    }
    /**
     * The response message for Operations.ListOperations.
     */
    interface Schema$GoogleLongrunning_ListOperationsResponse {
        /**
     ...
     * network API call.
     */
    interface Schema$GoogleLongrunning_Operation {
        /**
     ...
     */
    interface Schema$GoogleProtobuf_Empty {
    }
    /**
     ...
     */
    interface Schema$GoogleRpc_Status {
        /**
    ...
    class Resource$Operations {
         ...
         */
        cancel(params?: Params$Resource$Operations$Cancel, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobuf_Empty>;
        cancel(params: Params$Resource$Operations$Cancel, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobuf_Empty>, callback: BodyResponseCallback<Schema$GoogleProtobuf_Empty>): void;
        cancel(params: Params$Resource$Operations$Cancel, callback: BodyResponseCallback<Schema$GoogleProtobuf_Empty>): void;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Operations$Delete, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobuf_Empty>;
        delete(params: Params$Resource$Operations$Delete, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobuf_Empty>, callback: BodyResponseCallback<Schema$GoogleProtobuf_Empty>): void;
        delete(params: Params$Resource$Operations$Delete, callback: BodyResponseCallback<Schema$GoogleProtobuf_Empty>): void;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Operations$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunning_Operation>;
        get(params: Params$Resource$Operations$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunning_Operation>, callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
        get(params: Params$Resource$Operations$Get, callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Operations$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunning_ListOperationsResponse>;
        list(params: Params$Resource$Operations$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunning_ListOperationsResponse>, callback: BodyResponseCallback<Schema$GoogleLongrunning_ListOperationsResponse>): void;
        list(params: Params$Resource$Operations$List, callback: BodyResponseCallback<Schema$GoogleLongrunning_ListOperationsResponse>): void;
    ...
    interface Params$Resource$Videos$Annotate extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
