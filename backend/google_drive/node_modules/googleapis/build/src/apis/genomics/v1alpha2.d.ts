 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/genomics/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/genomics/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/genomics/node_modules/googleapis-common';
export declare namespace genomics_v1alpha2 {
     ...
     */
    interface Schema$ControllerConfig {
        cmd?: string;
        disks?: {
            [key: string]: string;
        };
     ...
     */
    interface Schema$DockerExecutor {
        /**
     ...
     */
    interface Schema$ListPipelinesResponse {
        /**
     ...
     */
    interface Schema$LoggingOptions {
        /**
     ...
     * and must be a file.
     */
    interface Schema$PipelineParameter {
        /**
     ...
     */
    interface Schema$PipelineResources {
        /**
    ...
    interface Schema$RepeatedString {
        values?: string[];
    }
    /**
     * The pipeline run arguments.
     */
    interface Schema$RunPipelineArgs {
        /**
     ...
     */
    interface Schema$SetOperationStatusRequest {
        errorCode?: string;
        errorMessage?: string;
        operationId?: string;
     ...
     * execution.
     */
    interface Schema$TimestampEvent {
        /**
    ...
    interface Params$Resource$Pipelines$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Getcontrollerconfig extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Run extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Pipelines$Setoperationstatus extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
