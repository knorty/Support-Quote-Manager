 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/youtubereporting/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/youtubereporting/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/youtubereporting/node_modules/googleapis-common';
export declare namespace youtubereporting_v1 {
     ...
     * gdata
     */
    interface Schema$GdataBlobstore2Info {
        /**
         * gdata
         */
     ...
     * gdata
     */
    interface Schema$GdataCompositeMedia {
        /**
         * gdata
         */
        blobRef?: string;
     ...
     * gdata
     */
    interface Schema$GdataContentTypeInfo {
        /**
         * gdata
         */
        bestGuess?: string;
     ...
     * gdata
     */
    interface Schema$GdataDiffChecksumsResponse {
        /**
         * gdata
         */
     ...
     * gdata
     */
    interface Schema$GdataDiffDownloadResponse {
        /**
         * gdata
         */
        objectLocation?: Schema$GdataCompositeMedia;
     ...
     * gdata
     */
    interface Schema$GdataDiffUploadRequest {
        /**
         * gdata
         */
     ...
     * gdata
     */
    interface Schema$GdataDiffUploadResponse {
        /**
         * gdata
         */
        objectVersion?: string;
     ...
     * gdata
     */
    interface Schema$GdataDiffVersionResponse {
        /**
         * gdata
         */
        objectSizeBytes?: string;
     ...
     * gdata
     */
    interface Schema$GdataDownloadParameters {
        /**
         * gdata
         */
     ...
     * gdata
     */
    interface Schema$GdataObjectId {
        /**
         * gdata
         */
        bucketName?: string;
     ...
     */
    interface Schema$ListReportTypesResponse {
        /**
         * A token to retrieve next page of results. Pass this value in the
    ...
    interface Params$Resource$Jobs$Reports$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Jobs$Reports$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Reporttypes$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
