 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/indexing/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/indexing/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/indexing/node_modules/googleapis-common';
export declare namespace indexing_v3 {
    ...
    interface Params$Resource$Urlnotifications$Getmetadata extends StandardParameters {
        /**
    ...
    interface Params$Resource$Urlnotifications$Publish extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
