 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/androiddeviceprovisioning/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/androiddeviceprovisioning/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/androiddeviceprovisioning/node_modules/googleapis-common';
export declare namespace androiddeviceprovisioning_v1 {
     ...
     */
    interface Schema$ClaimDeviceRequest {
        /**
     ...
     */
    interface Schema$ClaimDeviceResponse {
        /**
     ...
     */
    interface Schema$ClaimDevicesRequest {
        /**
     ...
     */
    interface Schema$CreateCustomerRequest {
        /**
     ...
     */
    interface Schema$CustomerApplyConfigurationRequest {
        /**
     ...
     */
    interface Schema$CustomerListConfigurationsResponse {
        /**
         * The configurations.
         */
     ...
     */
    interface Schema$CustomerListCustomersResponse {
        /**
     ...
     */
    interface Schema$CustomerListDevicesResponse {
        /**
     ...
     */
    interface Schema$CustomerListDpcsResponse {
        /**
     ...
     */
    interface Schema$CustomerRemoveConfigurationRequest {
        /**
     ...
     */
    interface Schema$CustomerUnclaimDeviceRequest {
        /**
     ...
     * [Identifiers](/zero-touch/guides/identifiers).
     */
    interface Schema$DeviceIdentifier {
        /**
     ...
     * [Identifiers](/zero-touch/guides/identifiers).
     */
    interface Schema$DeviceReference {
        /**
     ...
     */
    interface Schema$DevicesLongRunningOperationMetadata {
        /**
     ...
     * operations](/zero-touch/guides/how-it-works#operations).
     */
    interface Schema$DevicesLongRunningOperationResponse {
        /**
     ...
     */
    interface Schema$FindDevicesByDeviceIdentifierResponse {
        /**
         * Found devices.
         */
        devices?: Schema$Device[];
     ...
     * Response containing found devices.
     */
    interface Schema$FindDevicesByOwnerResponse {
        /**
         * The customer&#39;s devices.
         */
        devices?: Schema$Device[];
     ...
     */
    interface Schema$ListCustomersResponse {
        /**
     ...
     */
    interface Schema$ListVendorCustomersResponse {
        /**
     ...
     */
    interface Schema$ListVendorsResponse {
        /**
         * A token to retrieve the next page of results. Omitted if no further
         * results are available.
         */
     ...
     */
    interface Schema$PartnerUnclaim {
        /**
     ...
     */
    interface Schema$PerDeviceStatusInBatch {
        /**
     ...
     */
    interface Schema$UnclaimDeviceRequest {
        /**
     ...
     */
    interface Schema$UnclaimDevicesRequest {
        /**
     ...
     */
    interface Schema$UpdateDeviceMetadataInBatchRequest {
        /**
     ...
     */
    interface Schema$UpdateDeviceMetadataRequest {
        /**
     ...
     */
    interface Schema$UpdateMetadataArguments {
        /**
         * Device ID of the device.
         */
        deviceId?: string;
    ...
    interface Params$Resource$Customers$List extends StandardParameters {
        /**
    ...
    interface Params$Resource$Customers$Configurations$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Configurations$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Configurations$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Configurations$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Configurations$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Devices$Applyconfiguration extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Devices$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Devices$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Devices$Removeconfiguration extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Devices$Unclaim extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Customers$Dpcs$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Customers$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Customers$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Claim extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Claimasync extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Findbyidentifier extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Findbyowner extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Metadata extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Unclaim extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Unclaimasync extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Devices$Updatemetadataasync extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Vendors$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Partners$Vendors$Customers$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
