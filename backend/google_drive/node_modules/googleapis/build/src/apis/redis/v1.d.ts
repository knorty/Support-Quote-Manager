 ...
 */
import { GaxiosPromise } from 'googleapis/build/src/apis/redis/node_modules/gaxios';
import { Compute, JWT, OAuth2Client, UserRefreshClient } from 'googleapis/build/src/apis/redis/node_modules/google-auth-library';
import { APIRequestContext, BodyResponseCallback, GlobalOptions, GoogleConfigurable, MethodOptions } from 'googleapis/build/src/apis/redis/node_modules/googleapis-common';
export declare namespace redis_v1 {
     ...
     */
    interface Schema$FailoverInstanceRequest {
        /**
     ...
     */
    interface Schema$GoogleCloudRedisV1LocationMetadata {
        /**
     ...
     */
    interface Schema$GoogleCloudRedisV1OperationMetadata {
        /**
         * API version.
         */
        apiVersion?: string;
     ...
     */
    interface Schema$GoogleCloudRedisV1ZoneMetadata {
    }
    /**
    ...
    interface Params$Resource$Projects$Locations$Instances$Failover extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
